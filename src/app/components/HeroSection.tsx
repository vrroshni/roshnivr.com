...
const HeroSection = () => {
  ...
  >
    ...
    >
      Roshni V R
      <span className="text-textGreen mt-2 lgl:mt-4">
    ...
    <a href="https://github.com/noorjsdivs" target="_blank">
      <motion.button
        ...
        className="w-52 h-14 text-sm font-titleFont border border-textGreen rounded-md text-textGreen tracking-wide hover:text-black hover:border-black  duration-300"
      >
