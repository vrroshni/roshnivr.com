        ...
        <div className="hidden mdl:inline-flex items-center gap-7">
            <ul className="flex text-[13px] gap-7">
                {
                    navlinks.map(({ name, link, delay },key) => (
                        <Link key={key}
                            className="flex items-center gap-1 text-base font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link"
                            href={link}
                        >
                            <motion.li
            ...
            <a href="/assets/noor_resume.pdf" target="_blank">
                <motion.button
                    ...
                    className="px-4 py-2 rounded-md text-textGreen text-base border border-textGreen hover:bg-hoverColor duration-300"
                >
                    Resume
                </motion.button>
            </a>
